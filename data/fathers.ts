...
export const fathers: Father[] = [
  ...
  },
  {
    ...
    img: "/assets/past. prof. chujor.jpeg",
    bio: "Prof. Chujor Jacob Chujor is a Professor of Counselling Psychology in the Department of Educational Psychology, Guidance and Counselling at the Faculty of Education, University of Port Harcourt. He holds a B.Ed, M.Ed, and Ph.D, with a specialization in Child and Adolescent Counselling.\n\nWith over three decades of professional experience, Prof. Chujor has served as a Lecturer and College Counsellor at the School of Nursing, Maiduguri (1990-1992), the School of Nursing, Midwifery, and Public Health Nursing College of Health Science and Technology, Port Harcourt (1992-2008), and the University of Port Harcourt (2008-2026).\n\nBeyond academia, Prof. Chujor is the Director of Dayspring Counselling Consultants, the first private counselling firm in Port Harcourt, providing corporate counselling services to secondary schools and individual clients since 1999. He also serves as Deputy Director and Clinical Co-ordinator of the Counselling and Human Development Centre, Uniport (July 2023-present).\n\nThroughout his career, Prof. Chujor has served the church as a District Pastor at DLBC (2008-2021) and currently as Campus Pastor at DLCF Uniport (2022-2026). He has published extensively in local and international journals and authored numerous textbooks. He is married and blessed with five children.",
  },
  {
    name: "Miebi Ofubu",
    role: "CAREER COACH",
