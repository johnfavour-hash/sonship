    ...
    <div className="min-h-screen pt-32 pb-24 bg-gray-50 px-4">
      <div className="max-w-4xl mx-auto text-center mb-16">
         <div className="inline-flex items-center space-x-2 bg-brand-gold/20 px-4 py-1 rounded-full mb-6">
            ...
            <span className="text-[10px] font-black text-brand-purple uppercase tracking-widest">Giving to Sonship Hub</span>
         </div>
      ...
      <div className="max-w-5xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12">
        ...
        <div className="lg:col-span-4 space-y-4">
          ...
          >
            ...
            <div className="text-left">
              <h3 className={`font-black text-xs uppercase tracking-widest ${method === 'local' ? 'text-white' : 'text-gray-900'}`}>Local Donation</h3>
        ...
        <div className="lg:col-span-8 bg-white rounded-3xl p-8 md:p-12 shadow-sm border border-gray-100">
          {method === 'international' ? (
            <div className="animate-in fade-in slide-in-from-right-4 duration-500">
              <h2 className="text-2xl font-black mb-8 uppercase tracking-tighter">Card Donation</h2>
            ...
            <div className="animate-in fade-in slide-in-from-right-4 duration-500">
              ...
              <p className="mt-8 text-xs text-gray-400 italic text-center">Please use "TITHE" or "OFFERING" as the transfer description.</p>
            </div>
          )}
        </div>
      </div>
